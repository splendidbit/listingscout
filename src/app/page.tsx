  ...
  return (
    <div className="min-h-screen bg-[#09090f]">
      ...
      <header className="border-b border-[#363a4f]">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Link
              href="/login"
              className="text-[#c4c5d6] hover:text-[#f0f0f6] text-sm font-medium"
            >
              Sign in
            </Link>
            <Button
      ...
      <section className="container mx-auto px-6 py-24 text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-[#f0f0f6] mb-6 max-w-4xl mx-auto">
          Find and qualify{' '}
          <span className="text-[#6366F1]">short-term rental</span> leads at
          scale
        </h1>
        <p className="text-lg text-[#c4c5d6] mb-8 max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-center space-x-4">
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="border-[#363a4f] text-[#f0f0f6] hover:bg-[#1c1d2b] hover:border-[#4a4d65]"
          >
      ...
      <section id="features" className="container mx-auto px-6 py-24">
        <h2 className="text-3xl font-bold text-[#f0f0f6] text-center mb-12">
          Everything you need to find STR opportunities
        </h2>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 rounded-xl bg-[#13141c] border border-[#363a4f]">
            <div className="p-3 rounded-lg bg-[#6366F1]/10 w-fit mb-4">
              <Database className="h-6 w-6 text-[#6366F1]" />
            </div>
            <h3 className="text-xl font-semibold text-[#f0f0f6] mb-2">
              Centralized Database
            </h3>
            <p className="text-[#c4c5d6]">
      ...
      {/* Footer */}
      <footer className="border-t border-[#363a4f] py-8">
        <div className="container mx-auto px-6 text-center text-sm text-[#9395a8]">
