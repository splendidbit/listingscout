    ...
    <div className="space-y-3">
      ...
      {breakdown.recommended_outreach_reason && (
        <div className="bg-[#6366F1]/10 border border-[#6366F1]/20 rounded p-2.5">
          ...
          <p className="text-xs text-[#F0F0F5] leading-relaxed">{breakdown.recommended_outreach_reason}</p>
        </div>
      )}
      ...
      {/* Market Deltas */}
      {hasNewScoring && (
        <div className="grid grid-cols-2 gap-2 pt-2 border-t border-[#2A2A3C]">
          {[
            ...
            <div key={item.label} className="flex items-center justify-between">
              <span className="text-xs text-[#9494A8]">{item.label}</span>
              <span className={cn(
                'text-xs font-mono',
                item.value ? 'text-[#F0F0F5]' : 'text-[#5C5C72]'
              )}>
                {item.value ?? '—'}
              </span>
            </div>
      ...
      <div className="flex items-center justify-between pt-2 border-t border-[#2A2A3C]">
        ...
        <span className="text-lg font-mono font-bold text-[#F0F0F5]">
