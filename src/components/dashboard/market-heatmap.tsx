    ...
    return (
      <Card className="bg-[#0F1117] border-[#2A2D42]">
        <CardHeader className="pb-2">
          <CardTitle className="text-base text-[#EEEEF4]">Market Distribution</CardTitle>
        </CardHeader>
  ...
  return (
    <Card className="bg-[#0F1117] border-[#2A2D42]">
      ...
      <CardContent>
        ...
        {/* Legend */}
        <div className="flex items-center justify-center gap-4 mt-4 pt-4 border-t border-[#2A2D42]">
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded bg-[#C7D2FE]" />
            <span className="text-xs text-[#B0B0C0]">Low</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded bg-[#818CF8]" />
            <span className="text-xs text-[#B0B0C0]">Medium</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded bg-[#6366F1]" />
            <span className="text-xs text-[#B0B0C0]">High</span>
          </div>
        </div>
      </CardContent>
    </Card>
